...
@section('title', 'Кейтеринг в Астане — Ёжик Кейтеринг | Фуршеты, банкеты, кофе-брейки')
@section('description', 'Услуги кейтеринга в Астане от компании «Ёжик». Организуем кофе-брейки, фуршеты и банкеты любого масштаба. Работаем с 2003 года. Заказать: +7 701 110-00-11')
@section('keywords', 'кейтеринг астана, фуршет астана, банкет астана, кофе брейк астана, выездной кейтеринг астана, организация мероприятий астана')
...
<main>
	...
	<section class="city-intro">
		<div class="main">
			<p class="intro-text">
				Компания «Ёжик Кейтеринг» предлагает полный спектр услуг выездного обслуживания в Астане. 
            ...
            <div class="services-grid">
                ...
                <div class="service-card">
                    ...
                    <div class="service-content">
                        ...
                        <a href="{{ route('astana.coffee-break') }}" class="service-btn">Подробнее</a>
                    </div>
                </div>
                ...
                <div class="service-card">
                    ...
                    <div class="service-content">
                        ...
                        <a href="{{ route('astana.furshet') }}" class="service-btn">Подробнее</a>
                    </div>
                </div>
                ...
                <div class="service-card">
                    ...
                    <div class="service-content">
                        ...
                        <a href="{{ route('astana.banket') }}" class="service-btn">Подробнее</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="city-benefits">
        <div class="main">
            <h2>Почему выбирают нас в Астане</h2>
            ...
            <div class="benefits-grid">
                <div class="benefit-item">
                    ...
                    <p>Филиал «Канапе-Кейтеринг» успешно работает в Астане</p>
                </div>
