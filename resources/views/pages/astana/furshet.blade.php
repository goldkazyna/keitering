...
@section('title', 'Фуршет в Астане - Ёжик кейтеринг')
@section('description', 'Организуем изысканные фуршеты в Астане для корпоративов, свадеб, презентаций. От классического до коктейльного формата.')
...
<main>
    ...
    <section class="service-intro">
        <div class="main">
            <p class="intro-text">
                Организуем изысканные фуршеты в Астане для корпоративов, свадеб, презентаций, открытий и частных торжеств. 
    ...
    <section class="service-geography">
        <div class="main">
            ...
            <div class="geography-content">
                <p>Обслуживаем все районы Астаны. Работаем на выездных площадках:</p>
                <ul>
