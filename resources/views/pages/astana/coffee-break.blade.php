...
@section('title', 'Кофе-брейк в Астане - Ёжик кейтеринг')
@section('description', 'Организуем изысканные кофе-брейки в Астане для конференций, семинаров, деловых встреч. Три формата: Стандарт, Бизнес, Премиум.')
...
<main>
    ...
    <section class="service-intro">
        <div class="main">
            <p class="intro-text">
                Организуем изысканные кофе-брейки в Астане для конференций, семинаров, деловых встреч и корпоративных мероприятий. 
    ...
    <section class="service-info">
        <div class="main">
            ...
            <p class="info-note">Работаем в будни, выходные и праздничные дни. Обслуживаем мероприятия по всей Астане</p>
        </div>
    </section>
