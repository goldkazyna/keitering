...
@section('description', 'Прозрачные цены на кейтеринг в Астане: кофе-брейк, фуршет, выездной банкет. Три пакета для любого бюджета.')
@section('keywords', 'цены кейтеринг астана, стоимость кейтеринга, цены на фуршет, цены на банкет')
