...
@section('title', 'Цены на кейтеринг в Алматы — Ёжик Кейтеринг')
@section('description', 'Цены на кейтеринг в Алматы: кофе-брейк от 2 500 ₸, фуршет от 6 000 ₸, банкет от 18 000 ₸. Доставка по городу. Заказать: +7 701 267-29-92')
@section('keywords', 'цены кейтеринг алматы, стоимость фуршета алматы, цены банкет алматы')
...
<main>
    ...
    <section class="pricing-hero">
        <div class="main">
            <h1>Цены на кейтеринг в Алматы</h1>
    ...
    <section class="pricing-intro">
        <div class="main">
            <div class="intro-content">
                ...
                <p>
                    Компания «Ёжик Кейтеринг» с 2003 года предоставляет услуги выездного обслуживания в Алматы. 
        ...
        <div class="main">
            ...
            <div class="simple-packages">
                <div class="simple-package-card">
                    ...
                    <a href="{{ route('almaty.coffee-break') }}" class="package-link">Подробнее →</a>
                </div>
        ...
        <div class="main">
            ...
            <div class="detailed-packages">
                <div class="detailed-package-card">
                    ...
                    <a href="{{ route('almaty.furshet') }}" class="package-btn-small">Заказать</a>
                </div>
        ...
        <div class="main">
            ...
            <div class="detailed-packages">
                <div class="detailed-package-card">
                    ...
                    <a href="{{ route('almaty.banket') }}" class="package-btn-small">Заказать</a>
                </div>
        ...
        <div class="main">
            ...
            <div class="info-grid">
                <div class="info-card">
                    ...
                    <p>Привезём всё необходимое в любую точку Алматы</p>
                </div>
                <div class="info-card">
