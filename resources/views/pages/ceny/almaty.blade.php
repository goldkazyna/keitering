...
@section('description', 'Прозрачные цены на кейтеринг в Алматы: кофе-брейк, фуршет, выездной банкет. Три пакета для любого бюджета.')
@section('keywords', 'цены кейтеринг алматы, стоимость кейтеринга, цены на фуршет, цены на банкет')
