...
@section('title', 'Выездной банкет в Алматы - Ёжик кейтеринг')
@section('description', 'Организуем выездные банкеты в Алматы на природе, в шатрах, на террасах. Ресторанный сервис на любой площадке.')
...
<main>
    ...
    <section class="service-hero" style="background-image: url('{{ asset('img/banket-hero.jpg') }}');">
        ...
        <div class="main">
            <h1>Выездной банкет в Алматы</h1>
    ...
    <section class="service-intro">
        <div class="main">
            <p class="intro-text">
                Организуем выездные банкеты в Алматы и области — на природе, в шатрах, на террасах, в загородных резиденциях 
    ...
    <section class="service-logistics">
        <div class="main">
            ...
            <div class="logistics-grid">
                ...
                <div class="logistics-item">
                    <h4>География</h4>
                    <p>Доставка по Алматы и области, выезды за город по согласованию</p>
                </div>
            </div>
