...
@section('title', 'Фуршет в Алматы - Ёжик кейтеринг')
@section('description', 'Организуем изысканные фуршеты в Алматы для корпоративов, свадеб, презентаций. От классического до коктейльного формата.')
...
<main>
    ...
    <section class="service-intro">
        <div class="main">
            <p class="intro-text">
                Организуем изысканные фуршеты в Алматы для корпоративов, свадеб, презентаций, открытий и частных торжеств. 
                Мы создаём атмосферу вкуса и лёгкости, где каждая деталь продумана: от меню до декора и подачи.
            </p>
        </div>
    </section>
        ...
        <div class="main">
            <div class="about-content">
                <div class="about-image">
                    <img src="{{ asset('img/furshet-about.jpg') }}" alt="Фуршет">
                </div>
                <div class="about-text">
                    <h2>Что такое фуршет?</h2>
                    <p>
                        Фуршет - это современный формат обслуживания, где гости свободно общаются, угощаются лёгкими закусками 
                        и напитками, а атмосфера создаёт настроение праздника и непринуждённости.
                    </p>
                    <p>
                        Команда Ёжик Кейтеринг превращает фуршет в полноценное гастро-событие: красиво, вкусно и удобно.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="service-formats">
        <div class="main">
            <h2>Форматы фуршетов</h2>
            <p class="section-subtitle">Мы предлагаем несколько форматов под любое мероприятие</p>
            
            <div class="formats-grid">
                <div class="format-card">
                    <h3>Классический фуршет</h3>
                    <p>Закуски на фуршетных столах, напитки, десерты</p>
                </div>
                
                <div class="format-card featured">
                    <div class="badge">Популярный</div>
                    <h3>Коктейльный фуршет</h3>
                    <p>Акцент на канапе, мини-блюдах, авторских напитках</p>
                </div>
                
                <div class="format-card">
                    <h3>Welcome-фуршет</h3>
                    <p>Лёгкое угощение перед основным мероприятием</p>
                </div>

                <div class="format-card">
                    <h3>Фуршет-ужин</h3>
                    <p>Сочетание закусок, горячих блюд и десертов для насыщенного вечера</p>
                </div>
            </div>
            ...
            <div class="format-details">
                <div class="detail-item">
                    ...
                    <strong>Продолжительность:</strong> от 1 до 7 часов
                </div>
                <div class="detail-item">
                    <span class="detail-icon">👥</span>
                    <strong>Количество гостей:</strong> от 20 до 300 человек (возможны и более масштабные мероприятия)
                </div>
            </div>
        </div>
    </section>
	...
	<section class="service-packages">
		<div class="main">
			...
			<p class="section-subtitle">Готовые решения под ваш бюджет и формат мероприятия</p>
...
<section class="service-info">
    <div class="main">
        <h2>Организация и сервис</h2>
        
        <div class="info-simple">
            <ul>
                <li>Минимальный заказ - от 20 человек</li>
                <li>В стоимость входит: доставка, посуда, приборы, салфетки, обслуживание</li>
                <li>При необходимости предоставляем мебель, фуршетные юбки и декор</li>
                <li>Расчёт персонала: 1 официант на 20 гостей</li>
            </ul>
        </div>

        <h3 class="formats-title">Форматы подачи</h3>
        <div class="formats-simple">
            <div class="format-simple-item">Классический фуршетный стол</div>
            <div class="format-simple-item">Разносная подача официантами</div>
            <div class="format-simple-item">Комбинированный вариант</div>
        </div>
        <p class="note">Для горячих блюд используем мармиты и подогревающие лампы</p>
    </div>
</section>
...
<section class="service-logistics">
    <div class="main">
        <h2>Время и логистика</h2>
        
        <div class="logistics-grid">
            <div class="logistics-item">
                <h4>Заказ оформляется</h4>
                <p>За 2–3 дня до мероприятия</p>
            </div>

            <div class="logistics-item">
                <h4>Время подготовки площадки</h4>
                <p>От 1,5 до 3 часов</p>
            </div>

            <div class="logistics-item">
                <h4>График работы</h4>
                <p>Работаем в выходные и праздничные дни</p>
            </div>
        </div>

        <p class="logistics-note">Обеспечиваем дозаполнение блюд по ходу обслуживания, чтобы фуршет выглядел идеально до конца</p>
    </div>
</section>
    ...
    <div class="main">
        ...
        <div class="additional-simple">
            <div class="additional-simple-item">
                <h4>Оформление</h4>
                <p>Декор столов, флористика, тематическое оформление</p>
            </div>

            <div class="additional-simple-item">
                <h4>Посуда</h4>
                <p>Одноразовая премиум или классическая стеклянная/фарфоровая</p>
            </div>

            <div class="additional-simple-item">
                <h4>Напитки</h4>
                <p>Лимонад-бар, кофейная станция, барная станция</p>
            </div>

            <div class="additional-simple-item">
                <h4>Welcome-зона</h4>
                <p>Можно заказать отдельно</p>
            </div>

            <div class="additional-simple-item">
                <h4>Брендирование</h4>
                <p>Салфетки, топперы, упаковка с логотипом вашей компании</p>
            </div>

            <div class="additional-simple-item">
                <h4>Мебель и декор</h4>
                <p>При необходимости предоставляем мебель, фуршетные юбки</p>
            </div>
        </div>
    </div>
</section>
...
<section class="service-pricing">
    <div class="main">
        ...
        <div class="pricing-benefits-box">
            ...
            <div class="benefits-list">
                <div class="benefit-badge">На мероприятия от 100 гостей</div>
                <div class="benefit-badge">Для постоянных клиентов</div>
                <div class="benefit-badge">При заказе дополнительных услуг</div>
            </div>
            <p class="cancellation-note">При отмене за 48 часов - возврат предоплаты 100%</p>
        </div>
    </div>
</section>
    ...
    <section class="service-geography">
        <div class="main">
            <h2>География обслуживания</h2>
            <div class="geography-content">
                <p>Обслуживаем все районы Алматы. Работаем на выездных площадках:</p>
                <ul>
                    <li>Банкетные залы</li>
                    <li>Бизнес-центры</li>
                    <li>Загородные базы</li>
                    <li>Шатры</li>
                    <li>Открытые площадки</li>
                </ul>
                <p class="note">Доставка в пригороды возможна, доплата рассчитывается индивидуально</p>
            </div>
        </div>
    </section>
