...
@section('title', 'Кейтеринг в Алматы — Ёжик Кейтеринг | Фуршеты, банкеты, кофе-брейки')
@section('description', 'Услуги кейтеринга в Алматы от компании «Ёжик». Организуем кофе-брейки, фуршеты и банкеты любого масштаба. Работаем с 2003 года. Заказать: +7 701 267-29-92')
@section('keywords', 'кейтеринг алматы, фуршет алматы, банкет алматы, кофе брейк алматы, выездной кейтеринг алматы, организация мероприятий алматы')
