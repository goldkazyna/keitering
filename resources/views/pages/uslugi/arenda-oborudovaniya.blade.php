...
@section('title', 'Аренда оборудования для мероприятий — Ёжик Кейтеринг')
@section('description', 'Аренда посуды, мебели, текстиля и оборудования для мероприятий в Алматы и Астане. Столы, стулья, шатры, посуда. Доставка и установка.')
@section('keywords', 'аренда оборудования, аренда посуды, аренда мебели для мероприятий, аренда шатров, аренда столов и стульев')
