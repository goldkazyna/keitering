...
@section('title', 'Выездной банкет - Ёжик кейтеринг')
@section('description', 'Организуем выездные банкеты в Астане и Алматы на природе, в шатрах, на террасах. Ресторанный сервис на любой площадке.')
@section('keywords', 'выездной банкет, банкет астана, банкет алматы, банкет на природе, организация банкета')
