...
@section('title', 'Кофе-брейк — заказать организацию кофе-брейка в Алматы и Астане')
@section('description', 'Организация кофе-брейков для конференций, семинаров, тренингов. Пакеты от 2 500 ₸/чел. Свежая выпечка, горячие напитки, доставка и сервировка. Звоните!')
@section('keywords', 'кофе брейк, заказать кофе брейк, кофе брейк алматы, кофе брейк астана, организация кофе брейка, кофе брейк на конференцию')
...
<main>
    ...
    <section class="service-intro">
        <div class="main">
            <p class="intro-text">
                Организуем изысканные кофе-брейки для конференций, семинаров, деловых встреч и корпоративных мероприятий 
                в Астане и Алматы. Наша команда берет на себя всё — от доставки и сервировки до подбора меню под формат 
                и бюджет вашего события.
            </p>
        </div>
    </section>
    ...
    <section class="city-selector">
        <div class="main">
            ...
            <div class="cities-grid">
                <a href="{{ route('astana.coffee-break') }}" class="city-card">
                    <div class="city-icon">
                    ...
                    <h3>Астана</h3>
                    <p>Кофе-брейк в столице</p>
                    <div class="city-arrow">→</div>
                </a>

                <a href="{{ route('almaty.coffee-break') }}" class="city-card">
                    <div class="city-icon">
                        <svg width="60" height="60" viewBox="0 0 24 24" fill="none">
                            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" stroke="white" stroke-width="2"/>
                            <circle cx="12" cy="10" r="3" stroke="white" stroke-width="2"/>
                    ...
                    <h3>Алматы</h3>
                    <p>Кофе-брейк в южной столице</p>
                    <div class="city-arrow">→</div>
                </a>
            </div>
        </div>
...
.service-hero{padding: 0px 0 60px 0 !important;}
/* Герой */
.service-hero {
