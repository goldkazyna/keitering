...
@section('title', 'Фуршет - Ёжик кейтеринг')
@section('description', 'Организуем изысканные фуршеты в Астане и Алматы для корпоративов, свадеб, презентаций. Элегантный формат для стильных событий.')
@section('keywords', 'фуршет, фуршет астана, фуршет алматы, фуршетное обслуживание, организация фуршета')
