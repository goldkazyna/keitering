...
@section('title', 'Фуршет — заказать организацию фуршета в Алматы и Астане')
@section('description', 'Организация фуршетов любого масштаба. Пакеты от 6 000 ₸/чел. Канапе, закуски, горячее, десерты. Полное обслуживание и оформление. Заказать: +7 701 267-29-92')
@section('keywords', 'фуршет, заказать фуршет, фуршет алматы, фуршет астана, организация фуршета, фуршетное обслуживание, фуршет на корпоратив')
...
<main>
    ...
    <section class="service-intro">
        <div class="main">
            <p class="intro-text">
                Организуем изысканные фуршеты в Астане и Алматы для корпоративов, свадеб, презентаций, открытий 
                и частных торжеств. Мы создаём атмосферу вкуса и лёгкости, где каждая деталь продумана: 
                от меню до декора и подачи.
            </p>
        </div>
    </section>
    ...
    <section class="city-selector">
        <div class="main">
            ...
            <div class="cities-grid">
                <a href="{{ route('astana.furshet') }}" class="city-card">
                    <div class="city-icon">
                    ...
                    <h3>Астана</h3>
                    <p>Фуршет в столице</p>
                    <div class="city-arrow">→</div>
                </a>

                <a href="{{ route('almaty.furshet') }}" class="city-card">
                    <div class="city-icon">
                        <svg width="60" height="60" viewBox="0 0 24 24" fill="none">
                            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" stroke="white" stroke-width="2"/>
                            <circle cx="12" cy="10" r="3" stroke="white" stroke-width="2"/>
