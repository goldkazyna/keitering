...
@section('title', 'Ифтар в Алматы — заказать Ифтар на Рамадан 2026 | Ёжик Кейтеринг')
@section('description', 'Организация Ифтар в Алматы на Рамадан 2026. Доставка сетов, выездной Ифтар с полным сервисом, Ифтар на студии. Сеты от 7 000 ₸. Халяль меню. Заказать: +7 701 267-29-92')
@section('keywords', 'ифтар алматы, ифтар доставка, ифтар кейтеринг, рамадан 2026, ифтар заказать, ауызашар алматы, ифтар меню')
...
<main>
    ...
    <section class="service-intro">
        <div class="main">
            <p class="intro-text">
                Рамадан 2026 начинается 16 февраля. Компания «Ёжик Кейтеринг» предлагает три формата организации Ифтар в Алматы: 
