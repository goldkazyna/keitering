...
@section('title', 'Контакты - Ёжик кейтеринг')
@section('description', 'Контактная информация компании Ёжик кейтеринг в Алматы. Телефон, адрес, email для заказа кейтеринга.')
@section('keywords', 'контакты, ёжик кейтеринг, алматы, телефон, адрес, заказать кейтеринг')
