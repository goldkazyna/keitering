...
@section('title', 'Меню кофе-брейка — Ёжик Кейтеринг | Алматы и Астана')
@section('description', 'Меню кофе-брейка: свежая выпечка, сэндвичи, канапе, горячие и холодные напитки. Пакеты от 2 500 ₸. Халяль, вегетарианские опции.')
@section('keywords', 'меню кофе брейка, выпечка для кофе брейка, напитки для кофе брейка')
