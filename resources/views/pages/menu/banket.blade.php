...
@section('title', 'Банкетное меню — Ёжик Кейтеринг | Алматы и Астана')
@section('description', 'Банкетное меню: салаты, горячие блюда, гарниры, десерты. Комфорт, Бизнес, Премиум пакеты. Халяль, вегетарианское, детское меню.')
@section('keywords', 'банкетное меню, меню банкета, горячие блюда для банкета')
