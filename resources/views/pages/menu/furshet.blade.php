...
@section('title', 'Фуршетное меню — Ёжик Кейтеринг | Алматы и Астана')
@section('description', 'Фуршетное меню: канапе, тарталетки, брускетты, мини-шашлычки, десерты. Холодные и горячие закуски. Пакеты от 6 000 ₸/чел.')
@section('keywords', 'фуршетное меню, меню фуршета, канапе, закуски для фуршета')
