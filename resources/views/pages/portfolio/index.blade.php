...
@section('title', 'Портфолио — Ёжик Кейтеринг | Наши работы')
@section('description', 'Портфолио кейтеринг компании «Ёжик»: фото с мероприятий, отзывы клиентов. Фуршеты, банкеты, кофе-брейки в Алматы и Астане.')
@section('keywords', 'портфолио кейтеринг, фото мероприятий, примеры фуршетов, примеры банкетов')
