...
<div class="admin-content">
    ...
    <form action="{{ route('admin.portfolio-categories.update', $portfolioCategory) }}" method="POST" class="admin-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            >{{ old('description', $portfolioCategory->description) }}</textarea>
        </div>
        ...
        <div class="form-group">
            <label class="checkbox-label">
                <input 
                    ...
                    name="show_on_home" 
                    value="1"
                    {{ old('show_on_home', $portfolioCategory->show_on_home) ? 'checked' : '' }}
                >
